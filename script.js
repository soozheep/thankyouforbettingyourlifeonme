const SITE_URL = 'https://thankyouforbettingyourlifeonme.vercel.app';
...
async function sharePage(){if(navigator.share){try{await navigator.share({title:'Thank You For Betting Your Life On Me — Sonic Remedy | Soozhee',text:'Thank You For Betting Your Life On Me by Soozhee. Sonic Remedy : Audiosensory Resonance | Trust Your Path.',url:SITE_URL});return}catch(e){}}await navigator.clipboard.writeText(SITE_URL);showToast('Link copied')}
